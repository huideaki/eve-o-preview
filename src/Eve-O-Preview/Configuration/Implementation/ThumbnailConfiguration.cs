...
namespace EveOPreview.Configuration.Implementation
{
    sealed class ThumbnailConfiguration : IThumbnailConfiguration
    {
        ...
        public ThumbnailConfiguration()
        {
            ...
            this.CycleClientGroups = new List<CycleClientGroups>
            {
                new CycleClientGroups
                {
                    CycleGroupName = "My Group",
                    CycleGroupForwardHotkeys = new List<string> { "F14", "Control+F14" },
                    CycleGroupBackwardHotkeys = new List<string> { "F13", "Control+F13" },
                    CycleGroupClientsOrder = new Dictionary<string, int>
                    {
        ...
        [JsonProperty("CycleClientGroups")]
        public List<CycleClientGroups> CycleClientGroups { get; set; }
